...
export default function ReputationPage() {
  return (
    <div className="container py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Wallet Reputation</h1>
        <p className="text-muted-foreground">Check any wallet's trading behavior before you follow them.</p>
      </div>
        ...
        <CardContent>
          <div className="flex flex-col md:flex-row gap-4">
            <div className="relative flex-1">
              ...
              <Input placeholder="Enter wallet address..." className="pl-9" defaultValue="Hx7K...j9P2" />
            </div>
            <ButtonGradient>Analyze</ButtonGradient>
          </div>
        </CardContent>
      </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="font-bold text-lg">87/100</span>
            </div>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                ...
                { token: "BOME", action: "Buy", amount: "$1,200", result: "+18.7%", date: "3 weeks ago", win: true },
              ].map((trade, i) => (
